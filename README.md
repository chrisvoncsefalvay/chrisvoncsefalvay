...
I'm Chris von Csefalvay, a Principal at [HCLTech](https://hcltech.com)'s AI Practice, leading post-training research and clinical intelligence. My work sits at the harder end of AI/ML: reinforcement learning from verifiable rewards, preference optimisation, agentic systems, and the gap between a model that demos well and one that actually works in production.

My work also extends to physical AI and robotics simulation. With Tamás Földi, I am a principal investigator of the [Asset Factory Blueprint](https://hcltech-robotics.github.io/asset-factory-blueprint/), an open-source reference implementation from HCLTech's Robotics Intelligence CoE for turning photographs, scans and CAD into reproducible OpenUSD assets and reinforcement learning environments. I am also one of the creators of [CERES](https://ceres.cam/), an open-source application that turns every Meta Quest headset into a high-quality capture device for egocentric hand-object interaction data.

My book **[The Craft of Post-Training: A Practical Guide for AI Engineers and Developers](https://nostarch.com/craft-of-post-training)** was published by No Starch Press in 2026 — a practical guide to turning foundation models into production-ready systems, from SFT and RLVR through GRPO, DPO, LoRA and agentic fine-tuning. You might also know me from the [world's largest collection of Covid-19 data](https://github.com/starschema/COVID-19-data), the [public data set on the 2019 Samoan measles outbreak](https://github.com/chrisvoncsefalvay/samoa-measles-2019), the [public data set on the 2018 West African EBOV outbreak](https://github.com/chrisvoncsefalvay/ebola_drc), [the first community-driven book on Julia](https://github.com/chrisvoncsefalvay/learn-julia-the-hard-way), and my monograph [Computational Modeling of Infectious Disease](https://www.elsevier.com/books/computational-modeling-of-infectious-diseases/csefalvay/978-0-323-95389-4) (Elsevier, 2023). I [write about things here](https://chrisvoncsefalvay.com/posts/) — lately, mostly about post-training, agentic systems, and the gap between AI hype and AI craft.

## Bio

I'm a computational epidemiologist and data scientist with a primary focus on AI/ML: post-training methods, agentic system design, and the practical problem of making foundation models reliable in high-stakes domains. I am the author of [Computational Modeling of Infectious Disease](https://computationalinfectiousdisease.com), a richly illustrated compendium on modern computational epidemiology, as well as [a growing body of research](papers).
...
I am currently a Principal at [HCLTech](https://www.hcltech.com/)'s AI Practice, leading post-training research and clinical intelligence. I advise the world's leading life sciences, medical devices and pharma companies on AI/ML strategy — principally how to build systems that are reliable, not merely impressive. I am also a visiting thesis supervisor for students on the data science track of the mathematics programme at the [Budapest University of Technology and Economics](https://www.bme.hu/?language=en).
...
* **AI/ML**: post-training methods (SFT, RLVR, GRPO, DPO, ORPO), agentic AI ecosystems, agentic fine-tuning, preference optimisation, emergence, simulation agents and hybrid simulact networks
...
I've lived with [neuromyelitis optica](https://en.wikipedia.org/wiki/Neuromyelitis_optica) since 2015, which landed me in a wheelchair but never slowed me down. It did, however, give my work a personal stake: to find ways in which machine intelligence and sensing can expand what people can do, see and perceive, on their own terms. My experience of spinal cord injury has shaped my interest in AI not as an academic pursuit for its own sake but as a means of extending human agency, independence and capability.

In what little is left of my free time, I'm an adaptive multisport athlete, competing in wheelchair rugby, adaptive rowing (category PR1) and the SkiErg (category SIT2). In the latter, I [currently hold the world records for 100m, 500m, 2,000m, 6,000m, 21,097m and 42,195m distances and the 60 minutes time](https://www.concept2.com/skierg/motivation/records/adaptive-world?event=&gender=M&age_category=30&adaptive=31&op=Search&form_id=concept2_record_search_form#results). I [occasionally rant and whine](https://chrisvoncsefalvay.com/posts/index.html#category=fitness) about my forays in the world of adaptive exercise and my attempts at doing so in a mostly science-based manner.
